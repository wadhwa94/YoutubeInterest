...
function signupExternalUser(accessToken) {
    $.ajax({
        ...
        success: function (response) {
            ...
            window.location.href = "/api/Account/ExternalLogin?provider=Google&response_type=token&client_id=self&redirect_uri=http%3A%2F%2Fyoutubeinterest.azurewebsites.net%2FLogin.html&state=W8XaDpYusZXDM6MZK4kN9gjHRgR4Uu5iknoOPz22Q2w1";
        }
    });
